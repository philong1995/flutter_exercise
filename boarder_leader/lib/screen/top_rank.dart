                    ...
                    children: [
                      ...
                      Expanded(
                          ...
                          child: Text(
                            list[1].name!,
                            style: AppStyle.h4
                                .copyWith(color: AppColors.rankColor),
                          )),
                      Expanded(
                          flex: 1,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        border: Border.all(color: AppColors.rankSilverOutside)),
                  ),
                )
              ]),
              Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(color: AppColors.rankGoldOutside)),
                  ),
                )
              ]),
              Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(color: AppColors.rankCurenOutside)),
                  ),
                )
              ]),
            ],
